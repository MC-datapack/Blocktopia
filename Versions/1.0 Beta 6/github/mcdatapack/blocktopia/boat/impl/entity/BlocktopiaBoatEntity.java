...
public class BlocktopiaBoatEntity extends class_1690 implements BlocktopiaBoatHolder {
    private static final class_2940<Optional<BlocktopiaBoatType>> BLOCKTOPIA_BOAT = class_2945.method_12791(BlocktopiaBoatEntity.class,
            BlocktopiaBoatTrackedData.HANDLER);

    public BlocktopiaBoatEntity(class_1299<? extends BlocktopiaBoatEntity> type, class_1937 world) {
        super(type, world);
    }

    public BlocktopiaBoatEntity(class_1937 world) {
        this(Blocktopia.BOAT, world);
    }

    public BlocktopiaBoatEntity(class_1937 world, double x, double y, double z) {
        this(Blocktopia.BOAT, world);
    ...
    protected class_2561 method_23315() {
        if (this.getBlocktopiaBoat() == null) {
            return class_1299.field_6121.method_5897();
        }
    ...
    public class_1792 method_7557() {
        return this.getBlocktopiaBoat().getItem();
    }
