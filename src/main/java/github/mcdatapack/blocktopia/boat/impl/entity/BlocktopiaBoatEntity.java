...
public class BlocktopiaBoatEntity extends BoatEntity implements BlocktopiaBoatHolder {
    private static final TrackedData<Optional<BlocktopiaBoatType>> BLOCKTOPIA_BOAT = DataTracker.registerData(BlocktopiaBoatEntity.class,
            BlocktopiaBoatTrackedData.HANDLER);

    public BlocktopiaBoatEntity(EntityType<? extends BlocktopiaBoatEntity> type, World world) {
        super(type, world);
    }

    public BlocktopiaBoatEntity(World world) {
        this(Blocktopia.BOAT, world);
    }

    public BlocktopiaBoatEntity(World world, double x, double y, double z) {
        this(Blocktopia.BOAT, world);
