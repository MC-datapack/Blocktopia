    ...
    static Biome createRainForestBiome(RegistryEntryLookup<PlacedFeature> registryEntryLookup, RegistryEntryLookup<ConfiguredCarver<?>> registryEntryLookupCarver) {
        ...
        GenerationSettings.Builder generationSettings = new GenerationSettings.Builder();
                ...
                addOres(generationSettings, registryEntryLookup)
                    ...
                    .feature(GenerationStep.Feature.VEGETAL_DECORATION, registryEntryLookup.getOrThrow(VegetationPlacedFeatures.BAMBOO_LIGHT))
                    ...
                    .feature(GenerationStep.Feature.VEGETAL_DECORATION, registryEntryLookup.getOrThrow(OceanPlacedFeatures.SEAGRASS_DEEP_WARM))
                    .feature(GenerationStep.Feature.VEGETAL_DECORATION, registryEntryLookup.getOrThrow(OceanPlacedFeatures.SEA_PICKLE))
                    .feature(GenerationStep.Feature.VEGETAL_DECORATION, registryEntryLookup.getOrThrow(OceanPlacedFeatures.KELP_WARM))
