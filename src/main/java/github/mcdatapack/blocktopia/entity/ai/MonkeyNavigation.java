package github.mcdatapack.blocktopia.entity.ai;
...
public class MonkeyNavigation extends MobNavigation {
    @Nullable
    private BlockPos targetPos;

    public MonkeyNavigation(MobEntity mobEntity, World world) {
