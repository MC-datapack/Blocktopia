...
import github.mcdatapack.blocktopia.screen.custom.screenhandler.AbstractExtendedAnvilScreenHandler;
...
public abstract class ExtendedAnvilScreen<T extends AbstractExtendedAnvilScreenHandler> extends ForgingScreen<T> {
    ...
    public ExtendedAnvilScreen(T handler, PlayerInventory inventory, Text title) {
