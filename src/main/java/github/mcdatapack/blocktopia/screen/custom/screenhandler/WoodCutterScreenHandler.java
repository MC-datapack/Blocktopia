...
public class WoodCutterScreenHandler extends ScreenHandler {
    ...
    public WoodCutterScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
        super(ModScreenHandlerTypes.WOOD_CUTTER_INVENTORY_SCREEN_HANDLER, syncId);
    ...
    private void updateInput(Inventory input, ItemStack stack) {
        ...
        if (!stack.isEmpty()) {
            this.availableRecipes = this.world.getRecipeManager().getAllMatches(ModRecipes.WOOD_CUTTING_RECIPE_TYPE, createRecipeInput(input), this.world);
        }
    }
    ...
    public ScreenHandlerType<?> getType() {
        return ModScreenHandlerTypes.WOOD_CUTTER_INVENTORY_SCREEN_HANDLER;
    }
    ...
    public ItemStack quickMove(PlayerEntity player, int slot) {
        ...
        if (slot2 != null && slot2.hasStack()) {
            ...
            } else if (this.world.getRecipeManager().getFirstMatch(ModRecipes.WOOD_CUTTING_RECIPE_TYPE, new SingleStackRecipeInput(itemStack2), this.world).isPresent()) {
