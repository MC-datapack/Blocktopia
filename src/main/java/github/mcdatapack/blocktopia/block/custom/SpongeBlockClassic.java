    ...
    private boolean absorbWater(World world, BlockPos pos) {
        return BlockPos.iterateRecursively(pos, BlocktopiaConfig.getConfig().spongeAbsorb, Integer.MAX_VALUE, (currentPos, queuer) -> {
            ...
            if (currentPos.equals(pos)) {
                ...
                if (!fluidState.isIn(ModTags.Fluids.CLASSIC_SPONGE_ABSORB) && !blockState.isIn(ModTags.Blocks.CLASSIC_SPONGE_REPLACEABLE)) {
                    return false;
                } else {
                    ...
                    if (blockState.getBlock() instanceof FluidBlock) {
                        ...
                        if (!blockState.isIn(ModTags.Blocks.CLASSIC_SPONGE_REPLACEABLE)) {
                            return false;
                        }
