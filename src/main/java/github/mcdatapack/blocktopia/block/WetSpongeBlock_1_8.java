...
public class WetSpongeBlock_1_8 extends Block {
    ...
    public WetSpongeBlock_1_8(AbstractBlock.Settings settings) {
        super(settings);
    }
    ...
    protected void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean notify) {
        if (world.getDimension().ultrawarm()) {
            world.setBlockState(pos, LegacyBlocks.SPONGE_1_8.getDefaultState(), Block.NOTIFY_ALL);
