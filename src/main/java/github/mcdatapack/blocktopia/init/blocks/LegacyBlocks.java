...
public class LegacyBlocks {
    ...
    public static final ExtendedRepeaterBlock REPEATER_B1_3 = register("repeater_b1_3", new ExtendedRepeaterBlock(copy(REPEATER))); //Locked from 1.4.2
    public static final ExtendedRepeaterBlock REPEATER_1_4_2 = register("repeater_1_4_2", new ExtendedRepeaterBlock(copy(REPEATER)));
    */
