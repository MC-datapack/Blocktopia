...
public class RecipeInit {
    public static final RecipeSerializer<LegacyCutterRecipe> LEGACY_CUTTER_RECIPE_SERIALIZER =
    ...
    public static final RecipeType<LegacyCutterRecipe> LEGACY_CUTTER_RECIPE_TYPE =
