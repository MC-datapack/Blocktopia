...
public class BiomeModificationInit {
    public static void load(BlocktopiaConfigData.PlacedFeatureConfig config) {
        ...
        if (config.legacy_diamond_ores.generate) {
            BiomeModifications.addFeature(
                    BiomeSelectors.foundInOverworld(),
                    GenerationStep.Feature.UNDERGROUND_ORES,
                    PlacedFeatureInit.DIAMOND_ORE_IN20100128_KEY
            );
            BiomeModifications.addFeature(
                    BiomeSelectors.foundInOverworld(),
                    GenerationStep.Feature.UNDERGROUND_ORES,
                    PlacedFeatureInit.DIAMOND_ORE_1_14_KEY
            );
        }
        ...
        //            BiomeSelectors.foundInOverworld(),
        //            GenerationStep.Feature.UNDERGROUND_ORES,
        //            PlacedFeatureInit.LAPIS_ORE_B1_2_KEY
        //    );
        //    BiomeModifications.addFeature(
        //            BiomeSelectors.foundInOverworld(),
        //            GenerationStep.Feature.UNDERGROUND_ORES,
        //            PlacedFeatureInit.LAPIS_ORE_1_14_KEY
        //    );
        //}
