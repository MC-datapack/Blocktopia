...
public class ItemGroupInit {
    ...
    public static ItemGroup NATURAL_BLOCKS_GROUP = register("natural_blocks_group", FabricItemGroup.builder()
            ...
            .entries((displayContext, entries) -> {
                ...
                entries.add(BlockInit.STRIPPED_POISONED_LOG);
                entries.add(BlockInit.POISONED_LEAVES);
                entries.add(BlockInit.POISONED_SAPLING);
                entries.add(BlockInit.POISONED_PLANKS);
                entries.add(BlockInit.POISONED_STAIRS);
                entries.add(BlockInit.POISONED_SLAB);
                entries.add(BlockInit.POISONED_FENCE);
                entries.add(BlockInit.POISONED_FENCE_GATE);
                entries.add(BlockInit.POISONED_PRESSURE_PLATE);
                entries.add(BlockInit.POISONED_BUTTON);
                entries.add(BlockInit.POISONED_DOOR);
    ...
    public static ItemGroup OTHER_ITEMS_GROUP = register("other_items_group", FabricItemGroup.builder()
            ...
            .entries((displayContext, entries) -> {
                ...
                entries.add(BlockInit.POISONED_CHAIR);
