...
public class TradeHandler {
    ...
    public static void load(int maxUses) {
        if (BlocktopiaConfig.getConfig().villagerConfig.blocktopiaVillagers) {
            TradeOfferHelper.registerVillagerOffers(ModVillagers.LEGACY, 1,
                    factories -> {
            ...
            TradeOfferHelper.registerVillagerOffers(ModVillagers.LEGACY, 2,
                    (factories) -> {
                        factories.add((entity, random) -> new TradeOffer(
                                new TradedItem(Items.EMERALD, 1),
            ...
            TradeOfferHelper.registerVillagerOffers(ModVillagers.LEGACY, 3,
                    (factories) -> {
                        factories.add((entity, random) -> new TradeOffer(
                                new TradedItem(Items.EMERALD, 1),
            ...
            TradeOfferHelper.registerVillagerOffers(ModVillagers.LEGACY, 4,
                    (factories) -> {
                        factories.add((entity, random) -> new TradeOffer(
            ...
            TradeOfferHelper.registerVillagerOffers(ModVillagers.LEGACY, 5,
                    (factories) -> {
                        factories.add((entity, random) -> new TradeOffer(
