...
public class ThunderingSmiteGenerator extends BlocktopiaEnchantmentGenerator {
    ...
    protected void configure(RegistryWrapper.WrapperLookup registries, Entries entries) {
        entries.add(EnchantmentInit.THUNDERING_SMITE_KEY, Enchantment.builder(
                ...
                new LightningEnchantmentEffect(EnchantmentLevelBasedValue.linear(1, 2))).build(EnchantmentInit.THUNDERING_SMITE_KEY.getValue()));
    }
}
