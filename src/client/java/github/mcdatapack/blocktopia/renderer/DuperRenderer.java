...
public class DuperRenderer implements BlockEntityRenderer<DuperBlockEntity> {
    ...
    private final DuperModel model;

    public DuperRenderer(BlockEntityRendererFactory.Context context) {
        this.context = context;
        this.model = new DuperModel(context.getLayerModelPart(DuperModel.LAYER));
    }

    @Override
    public void render(DuperBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        matrices.push();
        ...
        this.model.render(matrices, vertexConsumers.getBuffer(RenderLayer.getEntitySolid(DuperModel.TEXTURE_LOCATION)), light, overlay);
        matrices.pop();
    }
